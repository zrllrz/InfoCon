...
CUDA_VISIBLE_DEVICES=3 python train.py \
    ...
    --vq_elastic=True --coe_loss_tolerance=1.0 --coe_rate_tolerance=0.1 \
    --vq_log=True --vq_persistence=none --vq_kmeans_reset=1000 --vq_kmeans_step=100\
    --n_act_layer=3 \
    --n_commit_layer=3 \
    --subgoal_marginal=1e-6 \
    --model_name=rkac-elastic-contrast-legacy-code_10-subgoal-detach-persistence_none_wutreset-keg_0.1 \
