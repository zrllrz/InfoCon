...
CUDA_VISIBLE_DEVICES=4 python train.py \
    ...
    --vq_n_e=10 --vq_coe_ema=0.95 --KT=0.1 --vq_t_emb_rate=1.2 --vq_coe_r_l1=0.0 --vq_use_clip_decrease_r \
    --sa_type=egpthn --n_state_layer=3 --n_action_layer=1 --use_pos_emb \
    --model_name=GPTHN_NN_EMA_GOAL_RECS_TIME++LONERESET_CLUSCOS_ENCO+_ \
