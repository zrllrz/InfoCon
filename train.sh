...
CUDA_VISIBLE_DEVICES=1 python train.py \
    ...
    --n_key_layer=4 --use_ts --rate_ts=2.0 --te_key_dim=64 \
    --vq_n_e=10 --vq_use_ema --vq_coe_ema=0.5 --KT=1.0 --coe_lip=1.0001 \
    --sa_type=egpthn --n_state_layer=2 --n_action_layer=1 --use_pos_emb \
    --model_name=GPTHN_NN_EMA_EXPL_CLUS_NODISP_GOAL_RECS- \
