...
CUDA_VISIBLE_DEVICES=0 python train.py \
    ...
    --beta1=0.9 --beta2=0.95 --coe_cluster=0.1 --coe_rec=1.0 \
    --dropout=0.0 --n_head=8 --n_embd=128 --dim_key=128 --dim_e=128 \
    --n_key_layer=4 --use_ts --rate_ts=1.1 --te_key_dim=0 \
    --vq_n_e=10 --vq_use_ema --vq_coe_ema=0.5 --KT=0.1 --coe_lip=1.0001 \
    --sa_type=egpthn --n_state_layer=2 --n_action_layer=1 --use_pos_emb \
    --model_name=TEST_GPTHN_NN_EMA_EXPL_CLUS_NODISP_GOAL_RECS_NOTE- \
